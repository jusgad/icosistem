        ...
        return this.create('div', {
            ...
            children: [
                ...
                this.create('div', {
                    className: 'card-body',
                    children: [
                        config.title ? this.create('h5', {
                            className: 'card-title',
                            textContent: config.title
                        }) : null,
                        config.content ? this.create('div', {
                            className: 'card-content',
                            innerHTML: config.content
                        }) : null,
                        config.actions ? this.create('div', {
                            className: 'card-actions',
                            children: config.actions
                        }) : null
                    ].filter(Boolean)
                }),
                config.footer ? this.create('div', {
